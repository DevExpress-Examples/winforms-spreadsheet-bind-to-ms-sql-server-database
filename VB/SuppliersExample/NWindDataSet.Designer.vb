...
SELECT SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Country, Phone, Fax FROM Suppliers WHERE (SupplierID = @SupplierID)"
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(2).CommandText = "INSERT INTO [Suppliers] ([CompanyName], [ContactName], [ContactTitle], [Address], [City], [Country], [Phone], [Fax]) VALUES (@CompanyName, @ContactName, @ContactTitle, @Address, @City, @Country, @Phone, @Fax);
SELECT SupplierID, CompanyName, ContactName, ContactTitle, Address, City, Country, Phone, Fax FROM Suppliers WHERE (SupplierID = SCOPE_IDENTITY())"
